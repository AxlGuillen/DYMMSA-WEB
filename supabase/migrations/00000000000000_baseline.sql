-- ============================================================================
-- BASELINE para BD LOCAL de pruebas (Fase A · chore/local-e2e-supabase).
-- Reconstruido desde supabase/schema.sql (fuente de verdad: la nube vía MCP).
-- Refrescar este archivo cuando cambie el schema. NO se aplica a producción.
-- ============================================================================

-- Extensiones que el schema usa (moddatetime para triggers set_updated_at).
