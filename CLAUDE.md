...
| 6 — Mejoras UX | 🔄 | — |
| 7 — MCP interno | 🔄 lectura ✅ · escrituras acotadas (`create_task`, `update_task`, `set_inventory_location`) ✅ · OAuth 2.1 Supabase (conectores) ✅ · bloque Odoo (13 tools, fases 1-6) ✅ · horas (3 tools de lectura, #101) ✅ · núcleo transaccional solo-lectura por decisión | `src/lib/mcp/` + `/api/mcp` + `src/lib/odoo/` |
...
| **Decisión técnica no obvia** | Crear `DYMMSA/04-Decisiones-Tecnicas/ADR-XXX-nombre.md` (último: ADR-029) |
