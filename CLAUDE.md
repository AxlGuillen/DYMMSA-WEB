...
| 6 — Mejoras UX | 🔄 | — |
| 7 — MCP interno | 🔄 lectura ✅ · `create_task` ✅ · OAuth 2.1 Supabase (conectores) ✅ · bloque Odoo (13 tools, fases 1-6) ✅ · más escrituras aprobadas (por nivel de riesgo) | `src/lib/mcp/` + `/api/mcp` + `src/lib/odoo/` |
