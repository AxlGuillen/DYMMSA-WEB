...
- **Comando:** `bun run test` (1092 tests). Watch: `bun run test:watch`. Coverage: `bun run test:coverage`.
...
| **Decisión técnica no obvia** | Crear `DYMMSA/04-Decisiones-Tecnicas/ADR-XXX-nombre.md` (último: ADR-026) |
