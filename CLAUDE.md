...
| 6 — Mejoras UX | 🔄 | — |
| 7 — MCP interno | 🔄 lectura ✅ · escrituras acotadas (`create_task`, `update_task`, `set_inventory_location`, `mark_payable_paid`, `create_payable`) ✅ · OAuth 2.1 Supabase (conectores) ✅ · bloque Odoo (15 tools, fases 1-8) ✅ · horas (3 tools de lectura, #101) ✅ · cobertura de todos los módulos + test anti-drift (45 tools, #109/#110/#113) ✅ · núcleo transaccional solo-lectura por decisión | `src/lib/mcp/` + `/api/mcp` + `src/lib/odoo/` |
