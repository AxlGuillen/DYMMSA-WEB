...
| `sent_for_approval` | Link enviado al cliente. No editable por DYMMSA (solo lectura). |
...
| `converted_to_order` | Orden generada desde esta cotización. Estado terminal. |
...
| Término | Definición | Ver |
|---------|-----------|-----|
| **approval_token** | UUID v4 único por cotización. Se incluye en la URL pública de aprobación `/approve/[token]`. Accesible sin login. | [[03-Modulos/Aprobacion-por-Token#Seguridad y acceso]] |
