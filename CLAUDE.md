...
| 6 — Mejoras UX | 🔄 | — |
| 7 — MCP interno | 🔄 lectura ✅ · `create_task` ✅ · OAuth 2.1 Supabase (conectores) ✅ · bloque Odoo completo (9 tools, fases 1-4) ✅ · más escrituras aprobadas (por nivel de riesgo) | `src/lib/mcp/` + `/api/mcp` + `src/lib/odoo/` |
