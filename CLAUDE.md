...
- **Sin comentarios obvios.** Solo comentar WHY cuando no es evidente, en **máximo 2 líneas** con referencia corta (`ADR-XXX` / `#NN`) — la narrativa vive en CLAUDE.md y los ADRs, nunca en el código.
